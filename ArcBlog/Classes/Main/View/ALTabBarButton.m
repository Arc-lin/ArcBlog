...
#define ALImageRadius 0.7

@interface ALTabBarButton()

@property (nonatomic,weak) ALBadgeView *badgeView;

@end

@implementation ALTabBarButton

// 重写setHightlighted, 取消高亮做的事情
...
// 传递UITabBarItem 给 tabBarButton, 给tabBarButton 内容赋值
...
- (void)layoutSubviews{
    ...
    CGFloat imageH = self.bounds.size.height * ALImageRadius;
